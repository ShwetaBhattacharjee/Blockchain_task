        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8 relative z-10">
          ...
          <div className="bg-white/90 backdrop-blur-sm p-6 rounded-xl shadow-xl border border-white/20 hover:shadow-2xl transition-all duration-300">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p
                  className={`text-sm font-semibold ${
                    connectedAccount ? "text-emerald-600" : "text-red-600"
                  }`}
                >
              ...
              <Wallet
                className={`w-8 h-8 ${
                  connectedAccount ? "text-emerald-500" : "text-gray-400"
                }`}
              />
            </div>
          </div>
              ...
              {connectedAccount ? (
                ...
                <div className="space-y-4">
                  <div className="text-center py-6">
                    ...
                    <button
                      className="w-full bg-gradient-to-r from-blue-600 to-emerald-500 hover:from-blue-700 hover:to-emerald-600 text-white py-3 px-4 rounded-lg font-semibold transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105"
